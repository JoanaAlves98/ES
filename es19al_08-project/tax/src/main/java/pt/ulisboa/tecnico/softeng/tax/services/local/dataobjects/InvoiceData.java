...
public class InvoiceData {
	...
	public InvoiceData(String reference, String sellerNif, String buyerNif, String itemType,
		...
		this.date = date;
		this.time = this.time.withDate(this.date.getYear(), this.date.getMonthOfYear(), this.date.getDayOfMonth());
	}
	...
	public InvoiceData(Invoice invoice) {
		...
		this.time = invoice.getTime().withDate(this.date.getYear(), this.date.getMonthOfYear(), this.date.getDayOfMonth());
	}
