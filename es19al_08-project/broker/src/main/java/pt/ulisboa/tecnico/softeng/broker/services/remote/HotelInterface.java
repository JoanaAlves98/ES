...
public class HotelInterface {
    ...
    public RestRoomBookingData reserveRoom(RestRoomBookingData roomBookingData) {
        logger.info("reserveRoom arrival:{}, departure:{}, nif:{}, iban:{}, adventureId:{}, bookRoom:{}",
                roomBookingData.getArrival(), roomBookingData.getDeparture(), roomBookingData.getBuyerNif(),
                roomBookingData.getBuyerIban(), roomBookingData.getAdventureId(), roomBookingData.getBookRoom());
        RestTemplate restTemplate = new RestTemplate();
        try {
            return restTemplate.postForObject(ENDPOINT + "/rest/hotels/reserve", roomBookingData,
                    RestRoomBookingData.class);
        } catch (HttpClientErrorException e) {
            logger.info("reserveRoom HttpClientErrorException arrival:{}, departure:{}, nif:{}, iban:{}, adventureId:{}, bookRoom:{}",
                    roomBookingData.getArrival(), roomBookingData.getDeparture(), roomBookingData.getBuyerNif(),
                    roomBookingData.getBuyerIban(), roomBookingData.getAdventureId(), roomBookingData.getBookRoom());
            throw new HotelException();
        } catch (Exception e) {
            logger.info("reserveRoom Exception arrival:{}, departure:{}, nif:{}, iban:{},, adventureId:{}, bookRoom:{}", roomBookingData.getArrival(),
                    roomBookingData.getDeparture(), roomBookingData.getBuyerNif(), roomBookingData.getBuyerIban(),
                    roomBookingData.getAdventureId(), roomBookingData.getBookRoom());
