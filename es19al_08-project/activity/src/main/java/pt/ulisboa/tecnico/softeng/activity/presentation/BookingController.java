...
public class BookingController {
	...
	public String bookingSubmit(Model model, @PathVariable String codeProvider, @PathVariable String codeActivity,
		...
		logger.info("offerSubmit codeProvider:{}, codeActivity:{}, externalId:{}, bookingNIF:{}, bookingIBAN:{}, bookingAGE:{}", codeProvider, codeActivity,
    ...
    public String cancelSubmit(final Model model, @PathVariable final String codeProvider, @PathVariable final String codeActivity,
                               @PathVariable final String externalId, @PathVariable final String reference) {
        logger.debug("cancelSubmit");

        final ActivityInterface activityInterface = new ActivityInterface();

        try {
            final String cancelReservation = activityInterface.cancelReservation(reference);

            return "redirect:/providers/" + codeProvider + "/activities/" + codeActivity + "/offers/" + externalId + "/bookings/";

        } catch (final ActivityException actEx) {
