...
public class BookingController {
	...
	@RequestMapping(value = "/{reference}/bookings", method = RequestMethod.POST)
	public String cancelSubmit(Model model, @PathVariable String code, @PathVariable String number, @ModelAttribute RoomBookingData booking, @PathVariable String reference) {
		logger.info("bookingSubmit hotelCode:{}, roomNumber:{}, arrival:{}, departure:{}, nif:{}, iban:{}, reference:{}", code,
				number, booking.getArrival(), booking.getDeparture(), booking.getBuyerNif(), booking.getBuyerIban(), reference);
