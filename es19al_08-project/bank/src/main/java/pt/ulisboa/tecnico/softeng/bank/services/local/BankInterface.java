...
public class BankInterface {
    ...
    @Atomic(mode = TxMode.WRITE)
    public static void transfer(String code, String sourceiban, String targetiban, long amount) {
        if (sourceiban != null && targetiban != null) {

            WithdrawOperation withdrawOperation = getAccountByIban(sourceiban).withdraw(amount);
            withdrawOperation.setBank(getBankByCode(code));
            DepositOperation depositOperation = getAccountByIban(targetiban).deposit(amount);

            TransferOperation transferOperation = new TransferOperation();
            transferOperation.init(withdrawOperation, depositOperation, sourceiban, code + getBankByCode(code).getCounter());
